...
class EmailLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'from' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-08-06 14:29:48',
            'modified' => '2017-08-06 14:29:48'
        ],
    ];
}
